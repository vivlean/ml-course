...
class KNearestNeighbor:
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            A = self.X_train - X[i]
            dists[i:] = np.sqrt(np.diag(np.matmul(A, A.T)))
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def compute_distances_no_loops(self, X):
        ...
        dists = np.sqrt(X_squared.reshape(X_squared.shape[0], 1) + X_train_squared.reshape(1, X_train_squared.shape[0]) - 2*X_dot_X_train)
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            for _ in range(k):
              closest_y[_] = self.y_train[closest_indexes[_]]
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            #########################################################################
            # TODO:                                                                 #
